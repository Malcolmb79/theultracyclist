// Client-side mirror of api/_lib/atpPlan.ts - the athlete's real TrainingPeaks
// Annual Training Plan (ATP), entered manually from their own TrainingPeaks
// account (no live TrainingPeaks API integration exists here). Duplicated
// rather than shared across the api/src boundary, matching how this project
// already keeps small pure data/helpers (tss.ts, fitness.ts) decoupled there.
// Update both copies directly if the athlete's real ATP changes.
export type AtpWeek = {
